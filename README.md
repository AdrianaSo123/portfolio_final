...
The site source lives in `site/`. See `site/README.md` for local setup and scripts.
...
This demonstrates the ability to design AI systems that are usable, interpretable, and directly
integrated into real decision-making workflows.
